...
|---|---|---|
| [`minimax/`](minimax/) | Minimax com poda alfa-beta (raiz em paralelo a partir da profundidade 5, e modo Turbo em C++ com threads) | Fuga no Labirinto (estilo Tron): duas motos de luz disputam espaço num labirinto aleatório, e o agente escolhe o movimento que maximiza o próprio espaço e minimiza o do oponente |
